"""
Formulaire WTForms pour l'entité Maitre.
Aucun accès à la base de données ici (règle MVC du projet) : uniquement
la définition des champs et de leurs règles de validation.
"""
