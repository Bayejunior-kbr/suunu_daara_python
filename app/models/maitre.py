"""
Entité Maitre (serigne encadrant une ou plusieurs classes/halqas).

Clé primaire : matricule saisi par l'utilisateur (String), et non un
identifiant auto-incrémenté, conformément à l'énoncé du projet.
"""
